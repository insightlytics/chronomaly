...
class TestValueFilter:
    ...
    def test_value_filter_numeric_min(self):
        ...
        df = pd.DataFrame(
            {"deviation_pct": [5.0, 10.0, 15.0, 20.0], "metric": ["a", "b", "c", "d"]}
        )
    ...
    def test_value_filter_numeric_max(self):
        ...
        df = pd.DataFrame(
            {"sessions": [100, 500, 1000, 5000], "metric": ["a", "b", "c", "d"]}
        )
    ...
    def test_value_filter_combined_categorical_and_numeric(self):
        ...
        df = pd.DataFrame({"deviation_pct": [5.0, 15.0, 20.0, 25.0, 30.0]})
...
class TestCumulativeThresholdFilter:
    ...
    def test_cumulative_threshold_missing_column(self):
        ...
        df = pd.DataFrame({"metric": ["a", "b", "c"], "other": [100, 50, 30]})
    ...
    def test_cumulative_threshold_zero_total(self):
        ...
        df = pd.DataFrame({"metric": ["a", "b", "c"], "value": [0, 0, 0]})
    ...
    def test_cumulative_threshold_100_percent(self):
        ...
        df = pd.DataFrame({"metric": ["a", "b", "c"], "value": [100, 50, 30]})
    ...
    def test_cumulative_threshold_with_exclude_columns(self):
        ...
        filter = CumulativeThresholdFilter(
            "value", threshold_pct=0.80, exclude_columns=["date"]
        )
        result = filter.filter(df)
    ...
    def test_cumulative_threshold_non_sequential_indices(self):
        ...
        """
        df = pd.DataFrame(
            {"metric": ["a", "b", "c", "d"], "value": [100, 50, 30, 20]},  # Total=200
            index=[10, 5, 20, 3],
